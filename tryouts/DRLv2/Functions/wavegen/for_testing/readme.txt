wavegens MATLAB Python Package
...
2. Installing the wavegens Package

A. Change to the directory that contains the file setup.py and the subdirectory wavegens. 
...
3. Using the wavegens Package

The wavegens package is on your Python path. To import it into a Python script or 
session, execute:
